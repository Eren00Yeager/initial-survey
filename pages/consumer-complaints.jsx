            ...
            <div className={consumerStyles.container}>
                ...
                <div className={consumerStyles.foot} >
                    ...
                    <div className={consumerStyles.ab2}>
                        <div style={windowSize.width > 900 ? { width: '3.255vw', position: 'relative' } : { width: '20vw', position: 'relative' }}><Image src={z1} layout='responsive'></Image></div>
                        <div style={windowSize.width > 900 ? { width: '3.255vw', position: 'relative' }: { width: '20vw', position: 'relative' }}><Image src={z2} layout='responsive'></Image></div>
                        <div style={windowSize.width > 900 ? { width: '3.255vw', position: 'relative' }: { width: '20vw', position: 'relative' }}><Image src={z3} layout='responsive'></Image></div>
