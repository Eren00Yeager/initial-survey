...
const cshare = ({cnam}) => {
  ...
  return (
       <div className={consumerStyles.tnk}>
           ...
           I have sent a legal notice to {cnam} for the inconvenience caused to me in the insurance claim process. Thanks to <a href="getyourrefunds.com" className={consumerStyles.web}>getyourrefunds.com</a>-GetYourRefunds for helping me take legal action for no extra cost.
           </div>
           <div>
