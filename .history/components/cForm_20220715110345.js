            ...
            <Accordion.Item eventKey="0" style={{ background: "#424242" }}>
                ...
                <Accordion.Body className={consumerStyles.cbd}>
                    ...
                    <Form.Group className={consumerStyles.det} >
                        ...
                        <Form.Control className={consumerStyles.plc} required name="address" placeholder="Address of Consumer" required onChange={onChangeHandler}/>
                    </Form.Group>
                </Accordion.Body>
            </Accordion.Item>
        </Accordion>
            ...
            <Accordion.Item eventKey="0" style={{ background: "#424242" }}>
                ...
                <SearchBar comp={comp} setCompany={setcnam}  setCId ={setcid}/>
                    ...
                    <Form.Group className={consumerStyles.det}>
                        ...
                        <Form.Select className={consumerStyles.pot} required name="problem" onChange={onChangeHandler}>
