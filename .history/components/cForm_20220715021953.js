            ...
            <Accordion.Item eventKey="0" style={{ background: "#424242" }}>
                ...
                <Accordion.Body className={consumerStyles.cbd}>
                    <Form.Group className={consumerStyles.det} >
                        ...
                        <Form.Control className={consumerStyles.plc} name="name" type="text" placeholder="Name" required/>
                    </Form.Group>

                    <Form.Group className={consumerStyles.det} >
                        {/* <Form.Label className={consumerStyles.nam}>Mobile No.</Form.Label> */}
                        <Form.Control className={consumerStyles.plc} name="mobnum" type="Mobile No." pattern="[0-9]{10}" placeholder="Mobile No." onChange={(e) => setMobile(e.target.value)} />
                    </Form.Group>

                    <Form.Group className={consumerStyles.det} >
                        {/* <Form.Label className={consumerStyles.nam}>Email Id.</Form.Label> */}
                        <Form.Control className={consumerStyles.plc} name="email" type="text" placeholder="Email Id." onChange={(e) => setMobile(e.target.value)} />
                    </Form.Group>
                    <Form.Group className={consumerStyles.det} >
                        {/* <Form.Label className={consumerStyles.nam}>Address of Consumer</Form.Label> */}
                        <Form.Control className={consumerStyles.plc} name="address" placeholder="Address of Consumer" />
                    </Form.Group>
                </Accordion.Body>
            </Accordion.Item>
        </Accordion>
