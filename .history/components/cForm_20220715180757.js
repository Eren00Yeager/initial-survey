        ...
        <Accordion >
            <Accordion.Item eventKey="0" style={{ background: "#424242" }}>
                ...
                <SearchBar comp={comp} setCompany={setcnam} setData={setData} setCId ={setcid} setcad={setcad}/>
                    <Form.Group className={consumerStyles.det} >
                        {/* <Form.Label className={consumerStyles.nam}>Name</Form.Label> */}
                        <Form.Control className={consumerStyles.plc} type="text" name="cost"  required placeholder="Cost of Product" onChange={onChangeHandler}/>
                    </Form.Group>
                    <Form.Group className={consumerStyles.det} >
                        {/* <Form.Label className={consumerStyles.nam}>Name</Form.Label> */}
                        <Form.Control className={consumerStyles.plc} type="text" name="order"  required placeholder="Invoice ID" onChange={onChangeHandler}/>
                    </Form.Group>
                    <Form.Group className={consumerStyles.det}>
