    ...
    return (
        <div className={consumerStyles.tnk}>
            ...
            <div className={consumerStyles.nt}>
                <CopyToClipboard>
                    I have sent a legal notice to {cnam} for the inconvenient services provided by the company. Thanks to -GetYourRefunds for helping me take legal action for no extra cost.
