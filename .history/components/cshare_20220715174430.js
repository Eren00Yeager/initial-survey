...
const cshare = ({cnam}) => {
    ...
    const text=`           I have sent a legal notice to ${cnam} for the inconvenient services provided by the company. Thanks to getyourrefunds.com-GetYourRefunds for helping me take legal action for no extra cost.</div>
    `;
