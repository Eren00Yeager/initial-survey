    ...
    return (
        <div className={consumerStyles.tnk}>
            ...
            <div className={consumerStyles.nt}>
                <CopyToClipboard>
                    I have sent a legal notice to {cnam} for the inconvenient services provided by the company. Thanks to <a href="https://getyourrefunds.com/" className={consumerStyles.web}>getyourrefunds.com</a>-GetYourRefunds for helping me take legal action for no extra cost.
                    <button className={consumerStyles.cpt}>Copy Message</button>
                </CopyToClipboard>
