...
export default function consumer() {
   ...
   dem:""
    ...
    const frm = (
        <Form className={consumerStyles.frm} method="post" onSubmit={submitHandler}>
                ...
                <Accordion>
                    <Accordion.Item eventKey="0" style={{ background: "#424242" }}>
                        ...
                        <Accordion.Body className={consumerStyles.cbd}>
                            <Form.Group className={consumerStyles.det} required>
                                {/* <Form.Label className={consumerStyles.nam}>Name</Form.Label> */}
                                <Form.Control className={consumerStyles.plc} type="text" placeholder="Name" />
                            </Form.Group>
