        ...
        <Form className={consumerStyles.frm} onSubmit={submitHandler}>
            ...
            {/* <div className={consumerStyles.details}> */}
                ...
                <Form.Group className={consumerStyles.det} >
                    ...
                    <Form.Control className={consumerStyles.plc} type="Mobile No." pattern="[0-9]{10}" placeholder="Mobile No." />
                </Form.Group>
                <div className={consumerStyles.det}>
                ...
                <Form.Group  className={consumerStyles.det}>
        <Form.Label className={consumerStyles.nam}>Disabled input</Form.Label>
        <Form.Control className={consumerStyles.plc} placeholder="Disabled input" />
      </Form.Group>
      <Form.Group className="mb-3">
        <Form.Label className={consumerStyles.nam}>Disabled select menu</Form.Label>
        <Form.Select className={consumerStyles.plc}>
          <option>Disabled select</option>
          <option>dsafjn</option>
          <option>kskjdjnfojn</option>
        </Form.Select>
      </Form.Group>
