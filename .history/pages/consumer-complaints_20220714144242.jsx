            ...
            <div className={consumerStyles.details}>
                <Accordion>
                    <Accordion.Item eventKey="0"  style={{background:"#424242"}}>
                        <Accordion.Header className={consumerStyles.id}>Consumer Details</Accordion.Header>
                        <Accordion.Body>
                ...
                <Accordion >
                    <Accordion.Item eventKey="0" style={{background:"#424242"}}>
                        <Accordion.Header className={consumerStyles.id}>Issues Faced</Accordion.Header>
                        <Accordion.Body>
                        <Form.Group className={consumerStyles.det}>
                    ...
                    <Form.Select className={consumerStyles.plc}>
                        ...
                        <option className={consumerStyles.pot}>Received an empty box</option>
                        <option className={consumerStyles.pot}>Late Delivery</option>
                        <option className={consumerStyles.pot}>Not satisfied with the service</option>
                    </Form.Select>
                </Form.Group>
                <Form.Group className={consumerStyles.det}>
