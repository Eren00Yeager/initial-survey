    ...
    const frm = (
        <Form className={consumerStyles.frm} onSubmit={submitHandler}>
            ...
            <Form.Group className={consumerStyles.det}>
                ...
                <Form.Control className={consumerStyles.plc} placeholder="Disabled input" />
            </Form.Group>
                    </Accordion.Body>
                </Accordion.Item>
                ...
                <Accordion.Item eventKey="1">
                    ...
                    <Accordion.Body>
                        <Form.Group className="mb-3" controlId="LawyerName">
                            ...
                            <Form.Control type="text" placeholder="Enter Name of Lawyer" />
                        ...
                        <Form.Group className="mb-3" controlId="LawyerAddress">
                            ...
                            <Form.Control type="text" placeholder="Enter ID of Lawyer" />
                        </Form.Group>
                        <Form.Group className="mb-3" controlId="LawyerAddress">
                            <Form.Label>Lawyer Address</Form.Label>
                            <Form.Control type="textarea" placeholder="Enter Address of Lawyer"/>
                        </Form.Group>
                        <Form.Group className="mb-3" controlId="LawyerPin">
                            <Form.Label>Lawyer Pin</Form.Label>
                            <Form.Control type="text" placeholder="Enter Pin of Lawyer" />
                        </Form.Group>
                        <Form.Group className="mb-3" controlId="LawyerPhone">
                            <Form.Label>Lawyer Phone</Form.Label>
                            <Form.Control type="text" placeholder="Enter Phone of Lawyer" />
                        </Form.Group>
                        <Form.Group className="mb-3" controlId="LawyerMobile">
                            <Form.Label>LawyerMobile</Form.Label>
                            <Form.Control type="text" placeholder="Enter Mobile of Lawyer" />
                        </Form.Group>
                    </Accordion.Body>
                </Accordion.Item>
            </Accordion>
